...
public class ServiceProduct_CreateStoreTest extends BaseCapabilitiesTest {
	@Test
	public void serviceProduct() throws InterruptedException {
		...
		wd.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//android.widget.TextView[@text='Set Your PIN']")));
		 ...
		 driver.findElement(By.xpath("//android.view.ViewGroup[@content-desc='Spices']")).click();
		 String url = driver.findElement(By.xpath("//android.widget.EditText[@text='shsf-spices.nextshopz.biz']")).getText();
		 ...
		 assertEquals(url, "shsf-spices.nextshopz.biz");
		 System.out.println("Service&Product " + url);
		 
	}
	
	@Test(dependsOnMethods = {"serviceProduct"})
