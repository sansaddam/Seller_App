...
public class SpaceStartEnd_StoreNameTest extends BaseCapabilitiesTest {
	@Test
	public void spaceStartEnd() throws InterruptedException {
		...
		wd.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//android.widget.TextView[@text='Set Your PIN']")));
		 ...
		 driver.findElement(By.xpath("//android.widget.EditText[@text='Enter Store Name']")).sendKeys("   SFSH   ");
