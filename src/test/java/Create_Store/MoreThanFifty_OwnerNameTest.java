...
public class MoreThanFifty_OwnerNameTest extends BaseCapabilitiesTest {
	@Test
	public void moreThanFifty() throws InterruptedException {
		...
		wd.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//android.widget.TextView[@text='Set Your PIN']")));
		 ...
		 driver.findElement(By.xpath("//android.widget.EditText[@text='Enter Owner Name']")).sendKeys("Saddamghgsafdghavdgdggdhagfgsdhggsdghabcdefghijklmnopqrstuvwxy");
		 driver.findElement(By.xpath("//android.widget.TextView[@text='Continue']")).click();
		 WebElement toast = wd.until(
				    ExpectedConditions.presenceOfElementLocated(
				        By.xpath("//android.widget.Toast[contains(@text,'Name should be less than 50 characters')]")
				    )
				);
