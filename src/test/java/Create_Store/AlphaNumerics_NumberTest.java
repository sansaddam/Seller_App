...
public class AlphaNumerics_NumberTest extends BaseCapabilitiesTest {
		@Test
		public void alphanumeric() {
			...
			driver.findElement(By.xpath("//android.widget.EditText[@text=\"Enter mobile number\"]")).sendKeys("Saddam1234");
