...
public class SpaceStartEnd_BusinessTypeTest extends BaseCapabilitiesTest {
	@Test
	public void maxLimit() throws InterruptedException {
		...
		wd.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//android.widget.TextView[@text='Set Your PIN']")));
		 ...
		 driver.findElement(AppiumBy.xpath("//android.widget.EditText[@text='Enter business name']")).sendKeys("  KilmS  ");
