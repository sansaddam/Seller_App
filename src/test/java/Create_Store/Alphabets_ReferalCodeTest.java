...
public class Alphabets_ReferalCodeTest extends BaseCapabilitiesTest {
	@Test
	public void alphabets() throws InterruptedException {
		...
		Thread.sleep(2000);
		 ...
		 Thread.sleep(1000);
		 driver.findElement(By.xpath("//android.widget.EditText[@text='Referal code (optional)']")).sendKeys("ADFhshghhs");
		 Thread.sleep(2000);
