...
public class SelectExisted_SubDomainTest extends BaseCapabilitiesTest {
	@Test
	public void selectExisted() throws InterruptedException {
		...
		wd.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//android.widget.TextView[@text='Set Your PIN']")));
		 ...
		 driver.findElement(By.xpath("//android.widget.TextView[@text='bakshs.nextshopz.biz']")).click();
		 ...
		 WebElement toast = wd.until(
				    ExpectedConditions.presenceOfElementLocated(
				        By.xpath("//android.widget.Toast[contains(@text,'Perfect! This domain is ready to use.')]")
				    )
				);
