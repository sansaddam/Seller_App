...
public class StartWithZero_NumberTest extends BaseCapabilitiesTest {
			@Test
			public void startWithZero() throws MalformedURLException {
				...
				driver.findElement(By.xpath("//android.widget.EditText[@text=\"Enter mobile number\"]")).sendKeys("0701407421");
