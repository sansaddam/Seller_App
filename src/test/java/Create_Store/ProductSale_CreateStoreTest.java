...
public class ProductSale_CreateStoreTest extends BaseCapabilitiesTest {
	@Test
	public void product() throws InterruptedException {
		...
		wd.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//android.widget.TextView[@text='Set Your PIN']")));
		 ...
		 String url = driver.findElement(By.xpath("//android.widget.TextView[@text='shsfbakery.nextshopz.biz']")).getText();
		 ...
		 assertEquals(url,"shsfbakery.nextshopz.biz");
		 System.out.println("Product_Sale "+ url);
	}
	...
	public void delete() throws InterruptedException {
		Thread.sleep(5000);
		 ...
		 Thread.sleep(2000);
		 driver.findElement(AppiumBy.xpath("//android.widget.TextView[@text=\" Yes,Delete Store\"]")).click();
	}
