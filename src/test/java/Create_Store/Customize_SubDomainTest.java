...
public class Customize_SubDomainTest extends BaseCapabilitiesTest {
		@Test
		public void customize() throws InterruptedException {
			...
			wd.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//android.widget.TextView[@text='Set Your PIN']")));
			 ...
			 driver.findElement(By.xpath("//android.widget.EditText")).sendKeys("bakery-sdsf.nextshopz.biz");
