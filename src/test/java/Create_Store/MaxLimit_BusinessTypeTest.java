...
public class MaxLimit_BusinessTypeTest extends BaseCapabilitiesTest {
	@Test
	public void maxLimit() throws InterruptedException {
		...
		wd.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//android.widget.TextView[@text='Set Your PIN']")));
		 ...
		 driver.findElement(AppiumBy.xpath("//android.widget.EditText[@text='Enter business name']")).sendKeys("KLIMhhhhhhhhhhhhhhhhhgggghhhhhhsansad");
		 driver.findElement(AppiumBy.xpath("//android.view.ViewGroup[@content-desc=' Save']")).click();
		 WebElement toast = wd.until(
				    ExpectedConditions.presenceOfElementLocated(
				        By.xpath("//android.widget.Toast[contains(@text,'BussinessName should be less than 30 characters')]")
				    )
				);
