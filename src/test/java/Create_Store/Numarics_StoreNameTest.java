...
public class Numarics_StoreNameTest extends BaseCapabilitiesTest {
	@Test
	public void numarics() throws InterruptedException {
		...
		WebElement store = driver.findElement(By.xpath("//android.widget.EditText[@text='Enter Store Name']"));
		 store.sendKeys("1254878214");
		 driver.findElement(By.xpath("//android.widget.TextView[@text='Continue']")).click();
		 String actual = store.getText();
			int length=actual.length();
			if (actual.equalsIgnoreCase("Enter Store Name") || length == 0) {
