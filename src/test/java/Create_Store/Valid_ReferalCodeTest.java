...
public class Valid_ReferalCodeTest extends BaseCapabilitiesTest {
	@Test
	public void valid() throws InterruptedException {
		...
		wd.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//android.widget.TextView[@text='Set Your PIN']")));
		 ...
		 String url = driver.findElement(By.xpath("//android.widget.EditText[@text='shsf-bakery.nextshopz.biz']")).getText();
		 ...
		 assertEquals(url, "shsf-bakery.nextshopz.biz");
		 System.out.println("Valid_Referal: "+url);
