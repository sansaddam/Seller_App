...
public class NegativeDurationHours_AddServiceTest extends Base_Utilities54Test{
	@Test
	public void negativeDuration() throws InterruptedException {
	    ...
	    driver.findElement(AppiumBy.xpath("//android.widget.EditText[@text=\"Duration of Service(in hours)\"]")).sendKeys("0");
	    ...
	    Thread.sleep(2000);
	    driver.findElement(AppiumBy.xpath("//android.widget.TextView[@text=\"Pricing Details\"]")).click();
	    driver.findElement(AppiumBy.xpath("//android.widget.TextView[@text=\"Duration of Service (e.g. Hours)\"]/following-sibling::android.widget.EditText[@text=\"0\"][1]")).isDisplayed();
	}
	public void swipeUp() {
