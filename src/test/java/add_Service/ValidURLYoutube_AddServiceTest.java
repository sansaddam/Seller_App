...
public class ValidURLYoutube_AddServiceTest extends Base_Utilities54Test{
	@Test
	public void validURLYoutube() throws InterruptedException {
		...
		driver.findElement(AppiumBy.xpath("//android.widget.EditText[@text=\"Enter video url\"]")).sendKeys("v=RvXEif7K9I4");
		driver.findElement(AppiumBy.xpath("//android.widget.EditText[@text=\"v=RvXEif7K9I4\"]")).isDisplayed();
