...
public class ValidRupessPer_ServiceTest extends Base_Utilities54Test{
	@Test
	public void validRupessPer() throws InterruptedException {
	    ...
	    driver.findElement(AppiumBy.xpath("//android.widget.EditText[@text=\"Unit Price(e.g 500 rs)\"]")).sendKeys("858");
	    driver.findElement(AppiumBy.xpath("//android.widget.TextView[@text=\"₹\"]")).click();
	    Thread.sleep(1000);
	    WebElement discount = driver.findElement(AppiumBy.xpath("//android.widget.EditText[@text=\"Discount\"]"));
	    discount.clear();
	    discount.sendKeys("50");
	    ...
	    Thread.sleep(2000);
	    driver.findElement(AppiumBy.xpath("//android.widget.TextView[@text=\"Pricing Details\"]")).click();
	    driver.findElement(AppiumBy.xpath("//android.widget.EditText[@text=\"50\"]")).isDisplayed();
	}
	public void swipeUp() {
