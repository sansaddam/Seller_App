...
public class EditMultiplePackages_ServiceTest extends Base_Utilities54Test{
	@Test
	public void editMultiplePackages() throws InterruptedException {
	    ...
	    WebElement name1 = driver.findElement(AppiumBy.xpath("//android.widget.EditText[@text=\"Normal\"]"));
	    name1.clear();
	    name1.sendKeys("Normal");
	    WebElement discription1 = driver.findElement(AppiumBy.xpath("//android.widget.EditText[@text=\"It is Normal\"]"));
	    discription1.clear();
	    discription1.sendKeys("It is Normal");
	    driver.findElement(AppiumBy.xpath("//android.widget.TextView[@text=\"Update\"]")).click();
	    WebElement toast1 = wd.until(ExpectedConditions.presenceOfElementLocated(AppiumBy.xpath("//android.widget.Toast[contains(@text,'Service package')]")));
	    Assert.assertNotNull(toast1, "Toast not Found");
	}
	public void swipeUp() {
