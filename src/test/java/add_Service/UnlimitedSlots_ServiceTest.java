...
public class UnlimitedSlots_ServiceTest extends Base_Utilities54Test{
	@Test
	public void unlimitedSlots() throws InterruptedException {
	...
	driver.findElement(AppiumBy.xpath("//android.widget.TextView[@text=\"Unlimited Slots\"]")).click();
    ...
    driver.findElement(AppiumBy.xpath("//android.widget.TextView[@text=\"Noraml\"]/parent::android.view.ViewGroup//(//android.view.ViewGroup[@content-desc=\"\"])[1]")).click();
    driver.findElement(AppiumBy.xpath("//android.view.ViewGroup[@content-desc=\"Unlimited Slots\"]/android.view.ViewGroup/android.view.ViewGroup")).isDisplayed();    
}
public void swipeUp() {
