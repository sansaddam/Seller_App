...
public class SpecialCharactersServiceName_AddServiceTest extends Base_Utilities54Test{
	@Test
	public void specialCharactersServiceName() throws InterruptedException {
		...
		driver.findElement(AppiumBy.xpath("//android.widget.EditText[@text=\"Enter service name\"]")).sendKeys("@!#$%^$#@#");
		driver.findElement(AppiumBy.xpath("(//android.widget.TextView[@text=\"Add Service\"])[2]")).click();
		WebElement toast = wd.until(
			    ExpectedConditions.presenceOfElementLocated(
			        AppiumBy.xpath("//android.widget.Toast[contains(@text,'Please enter service name')]")
			    )
			);
