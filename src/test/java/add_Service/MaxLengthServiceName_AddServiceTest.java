...
public class MaxLengthServiceName_AddServiceTest extends Base_Utilities54Test{
	@Test
	public void emptyPrice() throws InterruptedException {
		...
		driver.findElement(AppiumBy.xpath("//android.widget.EditText[@text=\"Enter service name\"]")).sendKeys("LapTopdddddddddddddddddddddddddddddddddddddddddddffffff");
		WebElement toast = wd.until(ExpectedConditions.presenceOfElementLocated(AppiumBy.xpath("//android.widget.Toast[@text=\"Service name should be 50 characters only\"]")));
