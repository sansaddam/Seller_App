...
public class MoreThanMaxDurationMinutes_ServiceTest extends Base_Utilities54Test{
	@Test
	public void moreThanMaxDurationMinutes() throws InterruptedException {
	    ...
	    driver.findElement(AppiumBy.xpath("//android.widget.EditText[@text=\"Duration of Service(in hours)\"]")).sendKeys("190");
	    ...
	    driver.findElement(AppiumBy.xpath("//android.widget.TextView[@resource-id=\"android:id/message\"]")).isDisplayed();
	}
	public void swipeUp() {
