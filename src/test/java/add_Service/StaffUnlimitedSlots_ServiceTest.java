...
public class StaffUnlimitedSlots_ServiceTest extends Base_Utilities54Test{
	@Test
	public void staffUnlimitedSlots() throws InterruptedException {
	...
	driver.findElement(AppiumBy.xpath("//android.widget.TextView[@text=\"Staff Unlimited Slots\"]")).click();
	Thread.sleep(1000);
	swipeUp1();
