...
public class MoreThanLimitDurationHours_AddServiceTest extends Base_Utilities54Test{
	@Test
	public void moreThanLimitDuration() throws InterruptedException {
	    ...
	    driver.findElement(AppiumBy.xpath("//android.widget.EditText[@text=\"Duration of Service(in hours)\"]")).sendKeys("4");
