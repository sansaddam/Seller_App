...
public class MoreThanMaxQuantity_ServiceTest extends Base_Utilities54Test{
	@Test
	public void moreThanMaxQuantity() throws InterruptedException {
	    ...
	    driver.findElement(AppiumBy.xpath("//android.widget.EditText[@text=\"e.g 1 per booking(up to 5 only)\"]")).sendKeys("6");
	    driver.findElement(AppiumBy.xpath("//android.widget.TextView[@text=\"Submit\"]")).click();
	    driver.findElement(AppiumBy.xpath("//android.widget.TextView[@text=\"Max quantity must be between 1 and 5\"]")).isDisplayed();
	}
	public void swipeUp() {
