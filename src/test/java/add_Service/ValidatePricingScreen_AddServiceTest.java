...
public class ValidatePricingScreen_AddServiceTest extends Base_Utilities54Test{
	@Test
	public void validatePricingScreen() throws InterruptedException {
	    ...
	    driver.findElement(AppiumBy.xpath("//android.widget.TextView[@text=\"Service Package Name\"]")).isDisplayed();
	}
	public void swipeUp() {
