...
public class MoreThanMaxUnitPrice_ServiceTest extends Base_Utilities54Test{
	@Test
	public void moreThanMaxUnitPrice() throws InterruptedException {
	    ...
	    driver.findElement(AppiumBy.xpath("//android.widget.EditText[@text=\"Unit Price(e.g 500 rs)\"]")).sendKeys("8585858585858585858585858585");
	    ...
	    Thread.sleep(2000);
	    driver.findElement(AppiumBy.xpath("//android.widget.TextView[@text=\"Pricing Details\"]")).click();
	    driver.findElement(AppiumBy.xpath("//android.widget.EditText[@text=\"8.585858585858586e+27\"]")).isDisplayed();
	}
	public void swipeUp() {
