...
public class PackageAvailabilityTime_ServiceTest extends Base_Utilities54Test{
	@Test
	public void packageAvailabilityTime() throws InterruptedException {
	...
	driver.findElement(AppiumBy.xpath("(//android.widget.EditText[@text=\"08:00\"])[1]")).isDisplayed();
    driver.findElement(AppiumBy.xpath("(//android.widget.EditText[@text=\"20:00\"])[1]")).isDisplayed();    
}
public void swipeUp() {
