...
public class LessThanMinPrice_AddServiceTest extends Base_Utilities54Test{
	@Test
	public void maxPrice() throws InterruptedException {
		...
		driver.findElement(AppiumBy.xpath("//android.widget.EditText[@text=\"Unit Price(e.g 500 rs)\"]")).sendKeys("0");
