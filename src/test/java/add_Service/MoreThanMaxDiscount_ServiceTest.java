...
public class MoreThanMaxDiscount_ServiceTest extends Base_Utilities54Test{
	@Test
	public void moreThanMaxDiscount() throws InterruptedException {
	    ...
	    driver.findElement(AppiumBy.xpath("//android.widget.TextView[@text=\"%\"]")).click();
	    driver.findElement(AppiumBy.xpath("//android.widget.EditText[@text=\"Discount\"]")).sendKeys("110");
	    ...
	    Thread.sleep(2000);
	    driver.findElement(AppiumBy.xpath("//android.widget.TextView[@text=\"Pricing Details\"]")).click();
	    driver.findElement(AppiumBy.xpath("//android.widget.EditText[@text=\"110\"]")).isDisplayed();
	}
	public void swipeUp() {
