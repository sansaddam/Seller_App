...
public class SelectMinGST_AddServiceTest extends Base_Utilities54Test{
	@Test
	public void selectMin() throws InterruptedException {
		...
		Thread.sleep(2000);
		driver.findElement(AppiumBy.xpath("//android.widget.TextView[@text=\"5%\"]")).isDisplayed();
	}
