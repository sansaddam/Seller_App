...
public class InvalidUnitPrice_AddServiceTest extends Base_Utilities54Test{
	@Test
	public void inValidateUnitPrice() throws InterruptedException {
	    ...
	    driver.findElement(AppiumBy.xpath("//android.widget.EditText[@text=\"Unit Price(e.g 500 rs)\"]")).sendKeys("fghjg");
	    driver.findElement(AppiumBy.xpath("//android.widget.TextView[@text=\"Submit\"]")).click();
	    driver.findElement(AppiumBy.xpath("//android.widget.TextView[@resource-id=\"com.nextshopz:id/alertTitle\"]")).isDisplayed();
	}
	public void swipeUp() {
