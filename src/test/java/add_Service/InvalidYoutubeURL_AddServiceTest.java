...
public class InvalidYoutubeURL_AddServiceTest extends Base_Utilities54Test{
	@Test
	public void inValidYoutubeURL() throws InterruptedException {
		...
		driver.findElement(AppiumBy.xpath("//android.widget.EditText[@text=\"Enter video url\"]")).sendKeys("https://www.youtube.com/watch?v=omnBa2V4I3Q");
		driver.findElement(AppiumBy.xpath("//android.widget.EditText[@text=\"https://www.youtube.com/watch?v=omnBa2V4I3Q\"]")).isDisplayed();
