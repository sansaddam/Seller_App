...
public class VerifyAddServiceButton_ServiceTest extends Base_Utilities54Test{
	@Test
	public void verifyAddServiceButton() throws InterruptedException {
		...
		driver.findElement(AppiumBy.xpath("//android.widget.EditText[@text=\"Enter service name\"]")).sendKeys("LaptopAC");
	    ...
	    driver.findElement(AppiumBy.xpath("//android.widget.TextView[@text=\"LaptopAC\"]")).click();
	    driver.findElement(AppiumBy.xpath("//android.widget.TextView[@text=\"\"]")).click();
