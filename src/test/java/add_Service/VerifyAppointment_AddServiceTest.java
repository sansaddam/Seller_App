...
public class VerifyAppointment_AddServiceTest extends Base_Utilities54Test{
	@Test
	public void verifyAppointment() throws InterruptedException {
		...
		driver.findElement(AppiumBy.xpath("//android.widget.CheckedTextView[@resource-id=\"android:id/text1\" and @text=\"Appointment\"]")).click();
