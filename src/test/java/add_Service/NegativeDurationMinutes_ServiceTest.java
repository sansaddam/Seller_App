...
public class NegativeDurationMinutes_ServiceTest extends Base_Utilities54Test{
	@Test
	public void negativeDurationMinutes() throws InterruptedException {
	    ...
	    Thread.sleep(2000);
	    driver.findElement(AppiumBy.xpath("//android.widget.TextView[@text=\"Pricing Details\"]")).click();
	    driver.findElement(AppiumBy.xpath("//android.widget.EditText[@text=\"-45\"]")).isDisplayed();
	}
	public void swipeUp() {
