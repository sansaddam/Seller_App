...
public class ValidateHourlyPrice_AddServiceTest extends Base_Utilities54Test{
	@Test
	public void validateHourlyPrice() throws InterruptedException {
	    ...
	    driver.findElement(AppiumBy.xpath("//android.widget.TextView[@text=\"Note : Max limit upto 3 hrs only \"]")).isDisplayed();
	}
	public void swipUp() {
