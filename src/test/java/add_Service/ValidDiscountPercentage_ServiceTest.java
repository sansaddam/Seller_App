...
public class ValidDiscountPercentage_ServiceTest extends Base_Utilities54Test{
	@Test
	public void validDiscountPercentage() throws InterruptedException {
	    ...
	    Thread.sleep(2000);
	    driver.findElement(AppiumBy.xpath("//android.widget.TextView[@text=\"Pricing Details\"]")).click();
	    driver.findElement(AppiumBy.xpath("//android.widget.EditText[@text=\"10\"]")).isDisplayed();
	}
	public void swipeUp() {
