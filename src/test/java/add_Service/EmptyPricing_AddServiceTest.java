...
public class EmptyPricing_AddServiceTest extends Base_Utilities54Test{
	@Test
	public void emptyPrice() throws InterruptedException {
		...
		WebElement toast = wd.until(ExpectedConditions.presenceOfElementLocated(AppiumBy.xpath("//android.widget.Toast[@text=\"Please update Price details\"]")));
