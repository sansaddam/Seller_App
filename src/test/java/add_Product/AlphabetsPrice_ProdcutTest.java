...
public class AlphabetsPrice_ProdcutTest extends Base_UtilitiesTest{
	@Test
	public void alphabetsPrice() throws InterruptedException {
		...
		driver.findElement(AppiumBy.xpath("//android.widget.EditText[@text=\"Enter price\"]")).sendKeys("Saddam");
		Thread.sleep(1000);
