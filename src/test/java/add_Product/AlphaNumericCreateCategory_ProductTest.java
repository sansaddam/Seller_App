...
public class AlphaNumericCreateCategory_ProductTest extends Base_UtilitiesTest{
	@Test
	public void alphaNumericCreateCategory() throws InterruptedException {
		...
		driver.findElement(AppiumBy.xpath("//android.widget.EditText[@text=\"Enter category name\"]")).sendKeys("CoolCake1529");
		...
		driver.findElement(AppiumBy.androidUIAutomator(
			    ...
			    ".scrollIntoView(new UiSelector().text(\"CoolCake1529\"))"
			));
		driver.findElement(AppiumBy.xpath("//android.widget.TextView[@text=\"CoolCake1529\"]/parent::android.view.ViewGroup//android.view.ViewGroup//android.widget.TextView")).click();
