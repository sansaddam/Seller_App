...
public class LessThan3Specification_ProductTest extends Base_UtilitiesTest{
	@Test
	public void lessThan3Specification() throws InterruptedException {
		...
		stock.sendKeys("50");
		driver.findElement(AppiumBy.xpath("//android.widget.TextView[@text=\"󰅀\"]")).click();
		Thread.sleep(1000);
		driver.findElement(AppiumBy.xpath("(//android.widget.TextView[@text=\"󰅂\"])[2]")).click();
		driver.findElement(AppiumBy.xpath("//android.widget.EditText[@text=\"Enter product description\"]")).sendKeys("ds");
		...
		driver.findElement(AppiumBy.xpath("//android.widget.TextView[@text=\"ds\"]")).isDisplayed();
		driver.findElement(AppiumBy.xpath("//android.widget.TextView[@text=\"\"]")).click();
		...
		WebElement toast = wd.until(
			    ExpectedConditions.presenceOfElementLocated(
			        AppiumBy.xpath("//android.widget.Toast[contains(@text,'Product delete')]")
			    )
			);
