...
public class AlphabetsDiscount_ProductTest extends Base_UtilitiesTest{
	@Test
	public void alphabetsDiscount() throws InterruptedException {
		...
		driver.findElement(AppiumBy.xpath("//android.widget.TextView[@text=\"%\"]")).click();
		driver.findElement(AppiumBy.xpath("//android.widget.EditText[@text=\"Enter discount\"]")).sendKeys("Saddam");
		Thread.sleep(1000);
