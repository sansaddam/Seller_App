...
public class AlphaNumericsAddValue_ProductTest extends Base_UtilitiesTest{
	@Test
	public void alphaNumericsAddValue() throws InterruptedException {
		...
		driver.findElement(AppiumBy.xpath("//android.widget.EditText[@text=\"Enter attribute value\"]")).sendKeys("gbs123");
		...
		try {
			...
			driver.findElement(AppiumBy.xpath("//android.widget.TextView[@text=\"gbs123\"]")).isDisplayed();
		}
	}
