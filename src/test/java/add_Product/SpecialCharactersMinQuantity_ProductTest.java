...
public class SpecialCharactersMinQuantity_ProductTest extends Base_UtilitiesTest{
	@Test
	public void specialCharactersMinQuantity() {
		...
		if (actual.isEmpty() || actual.matches("Enter minimum purchase quantity")) {
			assertTrue(true);
		}
		else {
			Assert.fail();
