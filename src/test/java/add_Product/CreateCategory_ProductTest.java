...
public class CreateCategory_ProductTest extends Base_UtilitiesTest{
	@Test
	public void allowedCharacters() throws InterruptedException {
		...
		driver.findElement(AppiumBy.xpath("//android.view.ViewGroup[@content-desc=\" + Add new category\"]")).click();
