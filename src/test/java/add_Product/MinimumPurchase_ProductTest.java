...
public class MinimumPurchase_ProductTest extends Base_UtilitiesTest{
	@Test
	public void minimumPurchase() {
		...
		WebElement msg = wd.until(ExpectedConditions.presenceOfElementLocated(AppiumBy.xpath("//android.widget.Toast[contains(@text,'Please enter price')]")));
