...
public class SpecialCharactersDiscount_ProductTest extends Base_UtilitiesTest{
	@Test
	public void specialCharactersDiscount() throws InterruptedException {
		...
		driver.findElement(AppiumBy.xpath("//android.widget.TextView[@text=\"%\"]")).click();
		driver.findElement(AppiumBy.xpath("//android.widget.EditText[@text=\"Enter discount\"]")).sendKeys("@#$%^&*");
		Thread.sleep(1000);
