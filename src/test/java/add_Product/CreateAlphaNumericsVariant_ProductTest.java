...
public class CreateAlphaNumericsVariant_ProductTest extends Base_UtilitiesTest{
	@Test
	public void createAlphaNumericsVariante() throws InterruptedException {
		...
		driver.findElement(AppiumBy.xpath("//android.widget.EditText[@text=\"Enter variant name\"]")).sendKeys("Ram123");
