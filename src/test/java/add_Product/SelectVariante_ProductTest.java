...
public class SelectVariante_ProductTest extends Base_UtilitiesTest{
	@Test
	public void selectVariante() throws InterruptedException {
		...
		Thread.sleep(2000);
		driver.findElement(AppiumBy.xpath("(//android.widget.TextView[@text=\"business\"])[1]")).isDisplayed();
	}
