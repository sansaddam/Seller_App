...
public class ZeroDiscount_ProductTest extends Base_UtilitiesTest{
	@Test
	public void zeroDiscount() throws InterruptedException {
		...
		driver.findElement(AppiumBy.xpath("//android.widget.EditText[@text=\"Enter discount\"]")).sendKeys("0");
		Thread.sleep(1000);
		driver.findElement(AppiumBy.xpath("//android.widget.TextView[@text=\"Minimum limit is 1\"]")).isDisplayed();
	}
