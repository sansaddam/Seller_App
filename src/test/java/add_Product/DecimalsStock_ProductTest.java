...
public class DecimalsStock_ProductTest extends Base_UtilitiesTest{
	@Test
	public void decimalStock() throws InterruptedException {
		...
		driver.findElement(AppiumBy.xpath("//android.widget.EditText[@text=\"Enter stock quantity\"]")).sendKeys("2.5");
	}
