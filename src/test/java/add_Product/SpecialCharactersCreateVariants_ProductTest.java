...
public class SpecialCharactersCreateVariants_ProductTest extends Base_UtilitiesTest{
	@Test
	public void specialCharactersCreateVariante() throws InterruptedException {
		...
		driver.findElement(AppiumBy.xpath("//android.widget.EditText[@text=\"Enter variant name\"]")).sendKeys("@#$%%^%^&");
		driver.findElement(AppiumBy.xpath("//android.widget.EditText[@text=\"Enter variant value\"]")).sendKeys("4gb");
