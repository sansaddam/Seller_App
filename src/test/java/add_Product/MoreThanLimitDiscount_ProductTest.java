...
public class MoreThanLimitDiscount_ProductTest extends Base_UtilitiesTest{
	@Test
	public void moreThanLimitDiscount() throws InterruptedException {
		...
		driver.findElement(AppiumBy.xpath("//android.widget.TextView[@text=\"%\"]")).click();
		driver.findElement(AppiumBy.xpath("//android.widget.EditText[@text=\"Enter discount\"]")).sendKeys("110");
		Thread.sleep(1000);
		driver.findElement(AppiumBy.xpath("//android.widget.TextView[@text=\"Discount percentage greater than 100\"]")).isDisplayed();
	}
