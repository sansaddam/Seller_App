...
public class RupeesDiscount_ProductTest extends Base_UtilitiesTest{
	@Test
	public void rupeesDiscount() throws InterruptedException {
		...
		Thread.sleep(2000);
		WebElement discountPrice = driver.findElement(AppiumBy.xpath("//android.widget.TextView[@text=\"Discounted price - 490.25\"]"));
		String actual = discountPrice.getText();
		String afterTrim = actual.replace("Discounted price - ", "").trim();
		assertEquals(afterTrim, "490.25");
	}
