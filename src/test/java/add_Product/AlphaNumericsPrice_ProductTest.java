...
public class AlphaNumericsPrice_ProductTest extends Base_UtilitiesTest{
	@Test
	public void alphaNumericsPrice() throws InterruptedException {
		...
		driver.findElement(AppiumBy.xpath("//android.widget.EditText[@text=\"Enter price\"]")).sendKeys("Saddam123");
		Thread.sleep(1000);
