...
public class LessThanThreeName_ProductTest extends Base_UtilitiesTest{
	@Test
	public void lessThanThreeName() throws InterruptedException {
		...
		driver.findElement(AppiumBy.xpath("//android.widget.EditText[@text=\"Enter product Name\"]")).sendKeys("La");
