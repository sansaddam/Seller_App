...
public class MaxLimitProductName_ProductTest extends Base_UtilitiesTest{
	@Test
	public void maxLimitName() throws InterruptedException {
		...
		driver.findElement(AppiumBy.xpath("//android.widget.EditText[@text=\"Enter product Name\"]")).sendKeys("LapTopSADDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDAM");
