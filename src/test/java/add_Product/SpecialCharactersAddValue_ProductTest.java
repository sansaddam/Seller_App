...
public class SpecialCharactersAddValue_ProductTest extends Base_UtilitiesTest{
	@Test
	public void specialCharactersAddValue() throws InterruptedException {
		...
		driver.findElement(AppiumBy.xpath("//android.widget.EditText[@text=\"Enter attribute value\"]")).sendKeys("@#$%^&*");
