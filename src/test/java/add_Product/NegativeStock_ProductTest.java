...
public class NegativeStock_ProductTest extends Base_UtilitiesTest{
	@Test
	public void negativeStock() throws InterruptedException {
		...
		driver.findElement(AppiumBy.xpath("//android.widget.EditText[@text=\"Enter stock quantity\"]")).sendKeys("-10");
	}
