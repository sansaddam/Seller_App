...
public class MoreThan2DecimalPrice_ProductTest extends Base_UtilitiesTest{
	@Test
	public void moreThan2DecimalPrice() throws InterruptedException {
		...
		driver.findElement(AppiumBy.xpath("//android.widget.EditText[@text=\"Enter price\"]")).sendKeys("250.8526");
		Thread.sleep(1000);
