...
public class BlankAddValue_ProductTest extends Base_UtilitiesTest{
	@Test
	public void blankAddValue() throws InterruptedException {
		...
		WebElement toast = wd.until(ExpectedConditions.presenceOfElementLocated(AppiumBy.xpath("//android.widget.Toast[contains(@text,'Please enter a value')]")));
