...
public class BlankCreateVariante_ProductTest extends Base_UtilitiesTest{
	@Test
	public void blankCreateVariante() throws InterruptedException {
		...
		try {
			WebElement toast = wd.until(
				    ExpectedConditions.presenceOfElementLocated(
				        AppiumBy.xpath("//android.widget.Toast[contains(@text,'Please enter variant name')]")
				    )
				);
