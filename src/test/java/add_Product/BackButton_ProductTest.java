...
public class BackButton_ProductTest extends Base_UtilitiesTest{
	@Test
	public void backButton() {
		...
		WebElement catalogueScreen = driver.findElement(AppiumBy.xpath("//android.widget.TextView[@text=\"Catalogue\"]"));
		if (catalogueScreen.isDisplayed()) {
			assertTrue(true);
		}
