...
public class NegativeLoyaltyPoints_ProductTest extends Base_UtilitiesTest{
	@Test
	public void negativeLoyaltyPoints() throws InterruptedException {
		...
		driver.findElement(AppiumBy.xpath("//android.widget.EditText[@text=\"Enter loyality points\"]")).sendKeys("-25");
	}
