...
public class NumbersMinPurchaseQuantity_ProductTest extends Base_UtilitiesTest{
	@Test
	public void numbersMinPurchaseQuantity() throws InterruptedException {
		...
		WebElement toast = wd.until(
			    ExpectedConditions.presenceOfElementLocated(
			        By.xpath("//android.widget.Toast[contains(@text,'Please enter price')]")
			    )
			);
