...
public class AlphaNumericsMinQuantity_ProductTest extends Base_UtilitiesTest{
	@Test
	public void alphabetsMinQuantity() {
		...
		min.clear();
		min.sendKeys("Saddam123");
		String actual = min.getText();
		if (actual.matches("123") || actual.matches("Enter minimum purchase quantity")) {
			assertTrue(true);
		}
		else {
			Assert.fail();
