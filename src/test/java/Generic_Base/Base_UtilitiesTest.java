...
public class Base_UtilitiesTest extends Generic_Base.BaseTest{
		@BeforeClass
		...
		public void login() throws InterruptedException {
			...
			driver.findElement(By.xpath("//android.widget.EditText[@text=\"Enter mobile number\"]")).sendKeys("8794561287");
