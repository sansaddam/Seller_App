...
public class SpecialCharacters_MobileTest extends BaseCapabilities56Test {
	@Test
	public void specialCharacters() {
		...
		driver.findElement(By.xpath("//android.widget.EditText[@text=\"Enter mobile number\"]")).sendKeys("@#$%^&*()!");
