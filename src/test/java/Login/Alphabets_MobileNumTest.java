...
public class Alphabets_MobileNumTest extends BaseCapabilities56Test {
	@Test
	public void alphabets() {
		...
		driver.findElement(By.xpath("//android.widget.EditText[@text=\"Enter mobile number\"]")).sendKeys("SanSadHuss");
