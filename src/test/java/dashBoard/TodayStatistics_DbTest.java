...
public class TodayStatistics_DbTest extends Base_Utilities54ProSerTest{
	@Test
	public void todayStatistics() {
		driver.findElement(AppiumBy.xpath("//android.widget.TextView[@text=\"This Week\"]")).click();
		driver.findElement(AppiumBy.xpath("//android.widget.TextView[@resource-id=\"Today\"]")).click();
		try {
